...
export const getCreateClaimMutationOptions = <TError = ErrorType<ErrorEnvelope>,
...
const {mutation: mutationOptions, request: requestOptions} = options ?
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type CreateClaimMutationError = ErrorType<ErrorEnvelope>

    /**
 * @summary Submit a damage claim (Schadenmeldung)
 */
export const useCreateClaim = <TError = ErrorType<ErrorEnvelope>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof createClaim>>, TError,{data: BodyType<ClaimInput>}, TContext>, request?: SecondParameter<typeof customFetch>}
 ): UseMutationResult<
